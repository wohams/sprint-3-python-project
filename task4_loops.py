...
for i in range(len(video_game_sales)):
    if video_game_sales[i][9] > 25:
        print(f'{video_game_sales[i][1]}, {video_game_sales[i][9]}')
...
na_sales, jp_sales = 0,0

for i in range(len(video_game_sales)):
    na_sales += video_game_sales[i][6]
    jp_sales += video_game_sales[i][8]

print(f'North America total: {na_sales}, Japan total: {jp_sales}')

if na_sales > jp_sales:
    print('North America had higher total sales than Japan.')
elif jp_sales > na_sales:
    print('Japan had higher total sales than North America.')
