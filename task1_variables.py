...
print(f'The average global sales across all {total_games} games is {avg_global_sales}.')

top_game_share = 100 * (video_game_sales[0][9] / total_global_sales)

print(f'Top game share: {top_game_share:0.2f}%.')
